    ...
    <header className="sticky flex flex-row items-center justify-between px-3 mx-5 transition-colors bg-gray-200 shadow-xl opacity-100 md:mx-20 dark:bg-gray-700 rounded-xl top-5">
      ...
      <div className='relative md:hidden'>
        <Menu>
          {({ open }) => (
            <Fragment>
              <Menu.Button className="flex flex-row items-center justify-center w-12 h-12 my-1 text-2xl text-gray-900 bg-gray-200 rounded-full hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600" aria-label='menu-button'>
